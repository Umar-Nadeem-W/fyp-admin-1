...
import { getAllPackages } from "../controllers/owner/package.js";
import { createCheckoutSession } from "../controllers/owner/stripeController.js";
import {getSubscriptionsByOwnerId} from "../controllers/owner/subscription.js"
import {getPondData} from "../controllers/owner/stock_data.js"  
...
router.post("/checkout", verifyToken, createCheckoutSession); // ✅ Protect route
...
router.get("/get-pond-data/:pondName", getPondData);
...
router.get("/get-subscriptions/:ownerId", verifyToken, getSubscriptionsByOwnerId);
